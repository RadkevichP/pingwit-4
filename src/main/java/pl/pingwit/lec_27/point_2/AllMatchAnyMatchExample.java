...
public class AllMatchAnyMatchExample {
    ...
    public static void main(String[] args) {
        ...
        boolean any = phones.stream()
                .filter(phone -> "Xiaomi".equals(phone.getBrand()))
                .anyMatch(phone -> phone.getYear() > 2020);

        boolean all = phones.stream()
                .filter(phone -> "Xiaomi".equals(phone.getBrand()))
                .allMatch(phone -> phone.getYear() > 2020);
